...
var startCronJobs = function () {
    ...
    node_cron_1.default.schedule('* * * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logger.info('Running scheduled task: Minute heartbeat');
                    heartbeatTask = {
                        id: (0, utils_1.generateId)('heartbeat'),
                        type: 'MONITOR_LOGS',
                        payload: { source: 'Orchestrator Heartbeat' },
                        createdAt: new Date().toISOString(),
                    };
                    return [4 /*yield*/, (0, queueService_1.enqueueTask)(heartbeatTask)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    node_cron_1.default.schedule('0 0 * * *', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logger_1.logger.info('Running scheduled task: Daily maintenance');
                    maintenanceTask = {
                        id: (0, utils_1.generateId)('maintenance'),
                        type: 'RUN_MAINTENANCE',
                        payload: { maintenanceType: 'Daily Cleanup' },
                        createdAt: new Date().toISOString(),
                    };
                    return [4 /*yield*/, (0, queueService_1.enqueueTask)(maintenanceTask)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
