...
CREATE TABLE "Brand" (
    ...
    "colorPalettes" JSONB,
    "logoIdeas" JSONB,
    "generatedLogoImage" TEXT,
    "typographyPairings" JSONB,
    "notionPageId" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "SelfRepairLog" (
    ...
    CONSTRAINT "SelfRepairLog_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "SelfRepairLog_userId_idx" ON "SelfRepairLog"("userId");
...
-- AddForeignKey
ALTER TABLE "SelfRepairLog" ADD CONSTRAINT "SelfRepairLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
